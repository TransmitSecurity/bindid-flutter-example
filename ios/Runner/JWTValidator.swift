...
//  BindID Example
//
//  Created by Shachar Udi on 12/07/2021.
//
...
class JWTValidator {
    ...
    public func validate(_ idToken: String, host: String, callback: @escaping (Bool, JWTValidatorError?) -> Void) {
        ...
        fetchBindIDPublicKey (host: host){ certificateBase64 in
            ...
            guard let iss = decodedPayload["iss"] as? String, // get issuer
                  ...
                  issuer.host == host.deletingPrefix("https://"), // compare issuer with BindID host
    ...
    private func fetchBindIDPublicKey(host: String, callback: @escaping (String?) -> Void) {
        let publicKeyEndPoint = "\(host)/jwks"
